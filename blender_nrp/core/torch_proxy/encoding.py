"""2D multiresolution hash encoding — port of nrp's `torch_backend/encoding.py`.

Plain-PyTorch instant-ngp grid encoding specialized to pixel coordinates. Kept
structurally identical to the nrp reference so `model.pt` state dicts round-trip
between the repos (same parameter names, same table layout).
"""
